...
class ThumbnailLargeBannerCard@JvmOverloads constructor(
    context: Context,
    attributeSet: AttributeSet? = null
) : CardView(context, attributeSet) {
    private var binding: OrganismThumbnailLargeBannerCardBinding? = null
    ...
    private fun refreshView() {
        ...
        binding?.apply {
            ...
            if (backgroundColorMode == BackgroundColorMode.DARK) {
                ...
                discountedPriceView.setTextColor(
                    ContextCompat.getColor(
                        context,
                        R.color.mud_palette_basic_white
                    )
    ...
    init {
        binding =
            OrganismThumbnailLargeBannerCardBinding.inflate(
